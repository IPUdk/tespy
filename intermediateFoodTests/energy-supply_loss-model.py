...
from tespy.components.newcomponents import DiabaticSimpleHeatExchanger,MassFactorLossModel,MergeWithPressureLoss,MassFactorVCC,SeparatorWithSpeciesSplits,SplitWithFlowSplitter,SeparatorWithSpeciesSplitsAndDeltaT,SeparatorWithSpeciesSplitsAndDeltaTAndPr,SeparatorWithSpeciesSplitsAndDeltaTAndPrAndBus
...
LossModel             = MassFactorLossModel('LossModel')
