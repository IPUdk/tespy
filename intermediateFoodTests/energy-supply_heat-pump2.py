...
from tespy.components.newcomponents import DiabaticSimpleHeatExchanger,MassFactorVCCWithPressureLoss,MergeWithPressureLoss,MassFactorVCC,SeparatorWithSpeciesSplits,SplitWithFlowSplitter,SeparatorWithSpeciesSplitsAndDeltaT,SeparatorWithSpeciesSplitsAndDeltaTAndPr,SeparatorWithSpeciesSplitsAndDeltaTAndPrAndBus
...
HeatPump              = MassFactorVCCWithPressureLoss('HeatPump')
