...
from tespy.components.newcomponents import DiabaticSimpleHeatExchanger,SplitterWithPressureLoss,MergeWithPressureLoss,SeparatorWithSpeciesSplits,SplitWithFlowSplitter,SeparatorWithSpeciesSplitsAndDeltaT,SeparatorWithSpeciesSplitsAndDeltaTAndPr,SeparatorWithSpeciesSplitsAndDeltaTAndPrAndBus
...
Splitter1              = SplitterWithPressureLoss('Splitter1',num_out = 2)
